...
<title>Bem-vindo(a) ao Hotel - Entrar!</title>
		...
		<form action="${loginUrl}" method="post">
			...
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" name="j_username" class="form-control" placeholder="Seu login de usuário" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input type="password" name="j_password" class="form-control" placeholder="Digite sua senha" />
				</div>
			</div>
